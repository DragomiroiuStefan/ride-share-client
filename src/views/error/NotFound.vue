<template>
    <div class="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
        <div class="flex flex-column align-items-center justify-content-center">
            <img src="@/assets/logo.svg" alt="Sakai logo" class="mb-5 w-4 flex-shrink-0" />
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(33, 150, 243, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    ...
                    <span class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                    ...
                    <span to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                    ...
                    <span to="/" class="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
